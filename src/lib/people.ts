...
export const SEED_POSITIONS: Position[] = [
  ...
  { id: 'P03', title: 'Dubai HoldCo Legal Counsel', department: 'Legal & Compliance', venture: 'LLIFE', type: 'Contract', status: 'hiring', priority: 'critical', targetStart: 'Q3 2026', location: 'Dubai (DIFC)', keySkills: ['DIFC / ADGM incorporation', 'Token structure and digital assets', 'UAE company law', 'Investment vehicle structuring', 'Smart contract legal review'], notes: 'DIFC-registered firm for HoldCo incorporation and token structure. Critical path for seed round.' },
  { id: 'P04', title: 'Full-Stack Engineer', department: 'Engineering', venture: 'LLIFE', type: 'Full-time', status: 'open', priority: 'critical', targetStart: 'Q4 2026', location: 'Mangaluru / Remote (IST overlap)', keySkills: ['TypeScript', 'Next.js + React', 'Convex (or Firebase/Supabase)', 'Stripe + Razorpay', 'Capacitor / mobile shells'], notes: 'First full-time engineering hire. Owns HubCV (live, scaling to 1.7M-school directory), Franchiseen (payout engine, needs shipping) and Roborns (static site, later investor portal). Budgeted $5K/month. Payments and reactive-backend experience matter more than years.' },
  ...
  { id: 'P07', title: 'Integrations Engineer', department: 'Engineering', venture: 'Llife', type: 'Full-time', status: 'on-hold', priority: 'medium', targetStart: 'Q1 2027', location: 'Remote / Mangaluru', keySkills: ['REST / API design', 'OAuth + consent flows', 'Account Aggregator', 'Data modelling', 'TypeScript'], notes: 'Owns the HubCV, Nanotrade, Franchiseen and AA connectors. On hold until the Education domain ships.' },
  { id: 'P08', title: 'Marketing & Content Lead', department: 'Marketing & Brand', venture: 'LLIFE', type: 'Full-time', status: 'open', priority: 'medium', targetStart: 'Q1 2027', location: 'Remote', keySkills: ['Content strategy', 'B2B marketing', 'SEO', 'Social media', 'Copywriting'], notes: 'Owns LLIFE brand voice and all venture content. Investor-facing communications included.' },
...
export const TRAINING: TrainingItem[] = [
  ...
  { title: 'Account Aggregator framework (RBI)', category: 'Engineering', assignee: 'Shawaz', status: 'completed', resource: 'Sahamati AA developer docs', notes: 'Studied as part of the Llife domain spec. Foundation for the Finances domain.' },
  { title: 'Next.js App Router — advanced patterns', category: 'Engineering', assignee: 'Shawaz', status: 'completed', resource: 'Next.js 16 docs / in-practice (hq.llife.app build)', notes: 'Server components, Convex Auth (Google OAuth), route protection, dynamic rendering.' },
  ...
  { title: 'DeFi protocol mechanics (GMX, dYdX)', category: 'Engineering', assignee: 'Shawaz', status: 'planned', resource: 'Protocol documentation + testnet usage', notes: 'Required for Nanotrade DeFi integration phase.' },
];
...
export const ONBOARDING_TEMPLATE: OnboardingStep[] = [
  { day: 'Day 1', title: 'Access & setup', category: 'Admin', items: ['Create LLIFE email account (X@llife.app)', 'Add to Google Workspace', 'GitHub organisation invite', 'HQ (hq.llife.app) account created', 'WhatsApp group added', 'Password manager set up (1Password / Bitwarden)', '2FA enabled on all accounts'] },
  { day: 'Day 1–2', title: 'Context & orientation', category: 'Culture', items: ['Read the LLIFE Handbook (hq.llife.app/dashboard/handbook)', 'Review all five venture pages on llife.app', 'Read through Plan and Strategy modules in HQ for your venture(s)', 'Meet founder 1:1 — 30 min overview call', 'Review current task list in HQ → Tasks'] },
