...
export const SEED_POSITIONS: Position[] = [
  ...
  { id: 'P04', title: 'Full-Stack Engineer', department: 'Engineering', venture: 'Codelude', type: 'Full-time', status: 'open', priority: 'critical', targetStart: 'Q4 2026', location: 'Mangaluru / Remote (IST overlap)', keySkills: ['TypeScript', 'Next.js + React', 'Convex (or Firebase/Supabase)', 'Stripe + Razorpay', 'Capacitor / mobile shells'], notes: 'First full-time engineering hire. Owns HubCV (live, scaling to 1.7M-school directory), Franchiseen (payout engine, needs shipping) and Roborns (static site, later investor portal). Budgeted $5K/month. Payments and reactive-backend experience matter more than years.' },
...
export const TRAINING: TrainingItem[] = [
  ...
  { title: 'Next.js App Router — advanced patterns', category: 'Engineering', assignee: 'Shawaz', status: 'completed', resource: 'Next.js 16 docs / in-practice (hq.codelude.com build)', notes: 'Server components, Convex Auth (Google OAuth), route protection, dynamic rendering.' },
