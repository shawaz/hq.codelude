...
export const STRATEGIES: VentureStrategy[] = [
  ...
  },
  {
    ...
    initiatives: [
      ...
      { title: 'Ship Dextrip + Franchiseen Earnings',   description: 'Job, Crypto and Stocks from Dextrip; franchise stakes from Franchiseen. Completes the Earnings domain and the daily net-worth roll-up.', priority: 'critical', status: 'planned' },
    ...
    threeYearVision: '100,000 daily active users across India and the Gulf, most arriving through HubCV and Dextrip. Llife becomes the consumer face of the Codelude ecosystem \u2014 the single daily surface where a user sees their education, earnings, finances, mind and body in one place.',
  },
];
...
export const ACTIVITIES: Activity[] = [
  ...
  { date: '2026-03-28', venture: 'Llife',     category: 'Partnership',  title: 'Internal API integrations scoped',       description: 'HubCV, Dextrip and Franchiseen agreed as the first data sources feeding the Education and Earnings domains.' },
  ...
  { date: '2026-02-10', venture: 'Llife',     category: 'Decision',     title: 'Ecosystem-first distribution chosen',        description: 'Decision: launch inside HubCV and Dextrip rather than standalone. Near-zero CAC and the board arrives pre-populated.' },
...
export const PARTNERS: Partner[] = [
  ...
  { name: 'HubCV / Dextrip (internal APIs)',     type: 'Technology',     ventures: ['Llife'],                 status: 'active',       role: 'Education, Job, Crypto and Stocks data feeding the Llife daily board',                                       nextAction: 'Finalise read scopes, auth model and rate limits for both APIs' },
...
export const CHANNELS: Channel[] = [
  ...
  { name: 'Ecosystem cross-sell',   type: 'Distribution', ventures: ['Llife'],                               status: 'building', description: 'Distribution through HubCV, Dextrip and Franchiseen user bases — the domains arrive already populated.', metric: 'Cross-signups from ecosystem' },
