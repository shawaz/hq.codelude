...
export const ACTIVITIES: Activity[] = [
  ...
  { date: '2026-06-13', venture: 'Roborns',     category: 'Decision',    title: 'Kapu site confirmed for 2MW pilot',   description: 'Uchila Thalapady cancelled — insufficient substation capacity. New primary site: Kapu, Udupi, Karnataka — 2 acres expandable to 4, 5km from substation. Phase 1 pilot at 2MW uses existing grid.' },
  { date: '2026-04-10', venture: 'Roborns',     category: 'Engineering',  title: 'Coastal site shortlisted',             description: 'Uchila Thalapady, Mangaluru identified as primary site. Coastal access, grid proximity, and water intake assessed. Later cancelled.' },
