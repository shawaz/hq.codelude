...
export const PARTNERS: Partner[] = [
  ...
  { name: 'Dubai HoldCo Legal Counsel (TBD)',    type: 'Financial',      ventures: ['Roborns', 'LLIFE'],     status: 'active',       role: 'Structure and incorporate the Dubai HoldCo vehicle for tokenisation',                                       nextAction: 'Finalise token term sheet and investor agreement templates' },
...
export const CHANNELS: Channel[] = [
  ...
  { name: 'Direct email outreach',  type: 'Sales',        ventures: ['Roborns', 'Franchiseen', 'LLIFE'],    status: 'active',   description: 'Targeted outreach to investors, engineering partners, and franchise brands. 1:1 relationship building',      metric: 'Meetings booked per week' },
  { name: 'LinkedIn',               type: 'Marketing',    ventures: ['LLIFE', 'HubCV'],                     status: 'building', description: 'Thought leadership content on deep-tech, franchise innovation, and career intelligence. Studio voice.',       metric: 'Post reach and follower growth' },
  ...
  { name: 'Investor network',       type: 'Sales',        ventures: ['Roborns', 'LLIFE'],                   status: 'active',   description: 'Direct relationships with strategic investors in deep-tech, real estate, and infrastructure. Dubai-anchored.',  metric: 'Investor conversations active' },
...
export const RELATIONS: Relation[] = [
  ...
  { name: 'Deep-Tech Advisors (TBD)',           category: 'Advisor',     ventures: ['Roborns', 'LLIFE'],      health: 'target',     description: 'Experienced operators in coastal infrastructure, energy, or desalination who can provide technical credibility and network access.',                   lastContact: 'Not yet',          nextStep: 'Identify 3 target advisors through engineering network' },
  ...
  { name: 'Beta Users (HubCV base)',            category: 'Customer',    ventures: ['Llife'],                  health: 'target',     description: 'HubCV students whose Education domain is populated from day one — the lowest-friction beta cohort.',                                            lastContact: 'Not yet',          nextStep: 'Launch beta waitlist on llife.app' },
];
