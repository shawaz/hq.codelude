...
export const VENTURE_PARTNERS: Record<string, Partner[]> = {
  Roborns: [
    ...
    { name: 'Thermax India',                    category: 'Thermal',                 type: 'Technology',    status: 'prospecting', role: 'Waste heat recovery engineering — integrates compute exhaust heat (55°C+) into MED distillation pre-heater loop in Building B', nextAction: 'Arrange technical meeting with Thermax energy recovery division for waste heat to MED feasibility study' },
    ...
    // ── RO & Desalination ─────────────────────────────────────────────────────
    { name: 'VA Tech Wabag',                    category: 'RO & Desalination',       type: 'Technology',    status: 'prospecting', role: 'Full MED and SWRO desalination skid — design, supply, and commissioning for 50,000 L/day from 2MW waste heat feed', nextAction: 'Send RFP for 50K L/day MED-TVC skid with seawater feed and 2MW thermal input specification' },
    ...
    { name: 'Praj Industries',                  category: 'RO & Desalination',       type: 'Technology',    status: 'identified',  role: 'ZLD system integration and brine management — process water and wastewater treatment engineering for Building B + C loop', nextAction: 'Connect with Praj ZLD/brine treatment team for Building C water loop design input' },
    ...
    { name: 'Submer Technologies',              category: 'Immersion & Liquid Cooling', type: 'Technology', status: 'identified',  role: 'SmartPodX modular immersion system — rack-dense pods compatible with GPU cluster density requirements', nextAction: 'Review Submer SmartPodX technical specs and request pilot pricing for 4-pod initial scope' },
    ...
    // ── Government & Legal ────────────────────────────────────────────────────
    { name: 'Karnataka Coastal Authority',      category: 'Government & Legal',      type: 'Government',    status: 'prospecting', role: 'Coastal construction permits, CRZ clearance, and environmental approval for the Uchila Thalapady site', nextAction: 'Appoint government liaison and arrange introductory meeting with Karnataka CRZ authority' },
    ...
    { name: 'MESCOM (Grid Provider)',           category: 'Government & Legal',      type: 'Government',    status: 'prospecting', role: '10MW industrial HT grid connection — transformer station and HT metering for the coastal facility', nextAction: 'Submit HT connection application to MESCOM Mangaluru circle' },
