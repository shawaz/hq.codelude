...
export const COMPETITORS: Competitor[] = [
  ...
  { name: '3Commas / Pionex (crypto bots)', venture: 'Nanotrade', type: 'Direct', strength: 'Established user base, simple UX', weakness: 'Custodial (holds user funds), limited strategy composability, CEX-only', ourEdge: 'Non-custodial — we never hold funds. Strategy marketplace with creator ecosystem. DeFi-native from day one.' },
  { name: 'dYdX / GMX (DeFi trading)', venture: 'Nanotrade', type: 'Adjacent', strength: 'Liquidity, protocol-native', weakness: 'Not automation tools — protocols, not strategy engines', ourEdge: 'We sit on top of DeFi protocols as the strategy/automation layer. Complementary, not competing.' },
];
...
export const CAMPAIGNS: Campaign[] = [
  ...
  { name: 'Nanotrade public beta launch campaign', venture: 'Nanotrade', type: 'Community', status: 'planned', channel: 'Twitter / X + Discord', start: '2026-07-10', end: '2026-07-31', goal: '200 beta sign-ups in first 30 days, 10 active strategy creators', notes: 'Creator-led launch. Each creator brings their audience. No paid acquisition until organic validated.' },
...
export const CONTENT: ContentItem[] = [
  ...
  { title: 'Nanotrade public beta — announcement post', venture: 'Nanotrade', type: 'Social Post', channel: 'Twitter + LinkedIn', status: 'planned', dueDate: '2026-07-10', notes: 'Beta launch announcement with strategy marketplace. Tag creator partners. Include waitlist link.' },
