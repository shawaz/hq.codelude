...
export const EVENTS: CalEvent[] = [
  ...
  { id: 'E10', date: '2026-06-15', time: '09:00', title: 'Cuestay hardware ODM factory call',                 type: 'Call',      venture: 'Cuestay',     location: 'Zoom',                  status: 'upcoming',  notes: 'Initial call with shortlisted ODM. Discuss MOQ, Matter certification status, lead times.' },
...
export const FILES: FileEntry[] = [
  ...
  { id: 'F05', name: 'Cuestay Hardware P&L',               venture: 'Cuestay',     category: 'Financial Model', format: 'XLSX',   version: 'v0.4', date: '2026-04-10', location: 'Google Drive / Finance / Cuestay',    status: 'draft',   notes: 'Hardware margin model, MOQ break-even, subscription attach rate.' },
  // Pitch Decks
  ...
  // Technical
  { id: 'F16', name: 'Cuestay Protocol Specification',    venture: 'Cuestay',     category: 'Technical',       format: 'MD',     version: 'v1.0', date: '2026-04-28', location: 'GitHub / cuestay / docs / protocol',  status: 'final',   notes: 'Matter protocol integration spec, AI layer architecture, hub hardware requirements.' },
