...
export const FILES: FileEntry[] = [
  ...
  // Brand
  { id: 'F14', name: 'Codelude Brand Guidelines',         venture: 'Codelude',    category: 'Brand',           format: 'Figma',  version: 'v1.0', date: '2026-05-20', location: 'Figma / Codelude / Brand',            status: 'final',   notes: 'Outfit typeface, accent #eeeeee, dark-first palette. Logo, typography, colour.' },
