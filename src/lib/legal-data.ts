...
export const CONTRACTS: Contract[] = [
  ...
  { id: 'CON-006', title: 'Domain Registrar Annual Renewal', party: 'Domain Registrar', type: 'SaaS', venture: 'LLIFE', value: '~$90/year (all domains)', startDate: 'Rolling', endDate: 'Rolling', status: 'active', keyTerms: 'Annual renewal for llife.app, roborns.com, franchiseen.com, hubcv.com, llife.app, nanotrade.com.', location: 'Domain registrar dashboard' },
];
