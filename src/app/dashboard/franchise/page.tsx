...
const STATUS_STYLES: Record<string, { color: string; label: string }> = {
  ...
  signed:      { color: '#dbdbdb', label: 'Signed'      },
...
export default function FranchisePage() {
  return (
    <div>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--card-border)', borderLeft: '2px solid #c8c8c8', padding: '1.25rem 1.5rem', marginBottom: '1.5rem' }}>
        <div style={{ fontFamily: 'var(--font-mono)', fontSize: '0.58rem', color: sc('#c8c8c8'), letterSpacing: '0.16em', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Target: Q3 2026</div>
          ...
          {FRANCHISE_BRANDS.map((b, i) => {
            ...
            return (
              <tr key={i}>
                ...
                <td style={{ textAlign: 'right', fontFamily: 'var(--font-mono)', fontSize: '0.7rem', color: sc('#dbdbdb') }}>{b.expectedRevenue}</td>
