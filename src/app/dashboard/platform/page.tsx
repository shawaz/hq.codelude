    ...
    platforms: [
      {
        ...
        kind: 'Web',
        status: 'building',
        note: 'AI Life Assistant — five-domain daily tracker (Finances, Education, Earnings, Mind, Body). Pulls from the HubCV, Nanotrade and Franchiseen APIs. In development.',
      },
    ],
  },
  {
    ...
    platforms: [
      {
        ...
        kind: 'Web',
        status: 'live',
        note: 'Main Nanotrade dashboard — strategies and account management',
      },
      {
        name: 'Nanotrade TV',
        domain: 'tv.nanotrade.com',
        port: 3002,
        pm2: 'nanotrade-tv-dashboard',
        stack: 'Next.js',
        kind: 'Web',
        status: 'live',
      ...
      {
        name: 'Nanotrade Multi-Bot',
        port: 8081,
        pm2: 'nanotrade-multi-bot',
      ...
      {
        name: 'Nanotrade Client Portal',
        domain: 'client.nanotrade.com',
        port: 3006,
        pm2: 'client-nanotrade',
