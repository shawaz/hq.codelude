...
export default function OffboardingPage() {
  const steps = [
    ...
    { phase: 'Within 24 hours', items: ['Disable Google Workspace account (retain email for 30 days, then delete)', 'Remove from GitHub organisation', 'Remove from HQ → Team (revoke their @llife.app Google access)', 'Remove from all WhatsApp / Telegram groups', 'Revoke 2FA tokens and access manager entries'] },
