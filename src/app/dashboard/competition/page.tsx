      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1px', background: 'var(--card-border)', border: '1px solid var(--card-border)' }}>
        {filtered.map((c, i) => (
          <div key={i} style={{ background: 'var(--card-bg)', padding: '1.25rem 1.5rem', display: 'grid', gridTemplateColumns: '180px 90px 1fr 1fr 1fr', gap: '1.25rem', alignItems: 'start' }}>
            ...
            <div>
              <div style={{ fontFamily: 'var(--font-mono)', fontSize: '0.55rem', color: '#5DCAA5', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '0.3rem' }}>Strength</div>
              <div style={{ fontFamily: 'var(--font-mono)', fontSize: '0.68rem', color: 'var(--muted)', lineHeight: 1.6, fontWeight: 300 }}>{c.strength}</div>
            </div>
            <div>
              <div style={{ fontFamily: 'var(--font-mono)', fontSize: '0.55rem', color: '#ff8080', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '0.3rem' }}>Weakness</div>
