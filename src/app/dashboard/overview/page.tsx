...
const ALL_VENTURE_CARDS = [
  ...
  { num: '04', name: 'Nanotrade',     sector: 'AI Trading Assistant',      color: '#adadad', status: 'Closed Beta',    desc: 'Strategy engine live with paying beta subscribers. Public beta and creator marketplace next.', metrics: [{ k: 'Stage', v: 'Closed beta' }, { k: 'Public beta', v: 'Q3 2026' }] },
  { num: '05', name: 'Llife',       sector: 'AI Life Assistant',         color: '#a5a5a5', status: 'Planning',       desc: 'Five-domain model defined. HubCV, Nanotrade and Franchiseen API integrations in build.',      metrics: [{ k: 'Stage', v: 'Planning' }, { k: 'Launch', v: '2027' }] },
];
